        ...
        <div class="section">
            <div class="login">
                ...
                <ul class="blist">
                    ...
                    <li class="item">
                        <input class="t_b btn_log" value="登录" type="submit" v-on:click="doLogin">
                    </li>
                    <li class="item">
                        <router-link :to="{path:'/reg'}" class="t_b btn_reg">
                            注册
                        </router-link>
                    </li>
                </ul>
...
<script type="text/ecmascript-6">
    export default {
            ...
            watch: {
                '$route' (to, from) {
                    if(to.name === 'login'){
                        this.$store.commit('headTitle', '登陆');
                    }
                }
            },
            mounted:function () {
            ...
            methods : {
                doLogin(){
                    let _this = this;
                    this.$http.post('http://www.sanye666.top/api/doLogin',{name:this.name,password:this.password},{emulateJSON: true}).then((response) => {
